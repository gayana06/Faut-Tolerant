 ...
 * @author nuno
 */
public class UniqueProcess implements Serializable
{
	...
	public UniqueProcess(SocketAddress addr, int proc, boolean self)
	{
		this.address = addr;
	...
	public boolean equals(Object test)
	{
		if (!(test instanceof Process))
			return false;
		UniqueProcess proc = (UniqueProcess) test;
	 ...
	 */
	public UniqueProcess cloneProcess()
	{
		UniqueProcess p = new UniqueProcess(address, processNumber, self);
		p.correct = correct;
